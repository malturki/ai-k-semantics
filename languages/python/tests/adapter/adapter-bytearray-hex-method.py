...
value = bytearray(b"UUDDLRLRAB")
mixed = bytearray([0, 1, 15, 16, 255])
...
unchanged_ok = (
    empty == bytearray()
    and data == bytearray(b"\xf0\xf1\xf2")
    and value == bytearray(b"UUDDLRLRAB")
    and mixed == bytearray([0, 1, 15, 16, 255])
)
