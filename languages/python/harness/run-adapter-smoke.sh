...
run_interactive_case() {
  ...
  local adapted="$WORK/$name.kinput.py"
  local reference="$WORK/$name.reference.out"
  local output="$WORK/$name.adapter.out"

  "$PYTHON_REF" -c 'import pathlib, sys; code = compile(pathlib.Path(sys.argv[1]).read_text(encoding="utf-8"), sys.argv[1], "single"); exec(code)' "$source" > "$reference"
  if ! grep -q -- "$expected_display" "$reference"; then
    echo "FAIL $name: CPython single-input display did not contain $expected_display" >&2
    cat "$reference" >&2
    exit 1
  fi

  "$PYTHON_REF" "$ADAPTER" --mode interactive "$source" > "$adapted"
  krun "$adapted" --definition "$KOMPILED" > "$output"
...
run_case "adapter-type-object-hierarchy" "$ROOT/tests/adapter/adapter-type-object-hierarchy.py" "True ~> .K"
run_case "adapter-object-constructor" "$ROOT/tests/adapter/adapter-object-constructor.py" "True ~> .K"
...
run_case "adapter-import-builtin-dunder" "$ROOT/tests/adapter/adapter-import-builtin-dunder.py" "True ~> .K"
run_case "adapter-builtins-module" "$ROOT/tests/adapter/adapter-builtins-module.py" "True ~> .K"
run_case "adapter-module-attribute-mutation" "$ROOT/tests/adapter/adapter-module-attribute-mutation.py" "True ~> .K"
run_case "adapter-module-import-cache-mutation" "$ROOT/tests/adapter/adapter-module-import-cache-mutation.py" "True ~> .K"
run_case "adapter-from-import-dynamic-module-attrs" "$ROOT/tests/adapter/adapter-from-import-dynamic-module-attrs.py" "True ~> .K"
...
run_case "adapter-hash-builtin" "$ROOT/tests/adapter/adapter-hash-builtin.py" "True ~> .K"
...
run_case "adapter-class-method-varargs-kw-only-kwargs" "$ROOT/tests/adapter/adapter-class-method-varargs-kw-only-kwargs.py" "True ~> .K"
...
run_case "adapter-class-method-kw-only" "$ROOT/tests/adapter/adapter-class-method-kw-only.py" "True ~> .K"
run_case "adapter-class-method-kw-only-kwargs" "$ROOT/tests/adapter/adapter-class-method-kw-only-kwargs.py" "True ~> .K"
run_case "adapter-class-method-pos-only-kw-only" "$ROOT/tests/adapter/adapter-class-method-pos-only-kw-only.py" "True ~> .K"
run_case "adapter-class-method-pos-only-varargs-kwargs" "$ROOT/tests/adapter/adapter-class-method-pos-only-varargs-kwargs.py" "True ~> .K"
...
run_case "adapter-bytes-percent-format-basic" "$ROOT/tests/adapter/adapter-bytes-percent-format-basic.py" "True ~> .K"
run_case "adapter-bytearray-percent-format-basic" "$ROOT/tests/adapter/adapter-bytearray-percent-format-basic.py" "True ~> .K"
run_case "adapter-bytes-percent-format-diagnostics" "$ROOT/tests/adapter/adapter-bytes-percent-format-diagnostics.py" "True ~> .K"
run_case "adapter-bytes-percent-format-numeric" "$ROOT/tests/adapter/adapter-bytes-percent-format-numeric.py" "True ~> .K"
run_case "adapter-bytearray-percent-format-numeric" "$ROOT/tests/adapter/adapter-bytearray-percent-format-numeric.py" "True ~> .K"
run_case "adapter-bytes-percent-format-numeric-diagnostics" "$ROOT/tests/adapter/adapter-bytes-percent-format-numeric-diagnostics.py" "True ~> .K"
run_case "adapter-bytes-percent-format-precision" "$ROOT/tests/adapter/adapter-bytes-percent-format-precision.py" "True ~> .K"
run_case "adapter-bytearray-percent-format-precision" "$ROOT/tests/adapter/adapter-bytearray-percent-format-precision.py" "True ~> .K"
run_case "adapter-bytes-percent-format-precision-diagnostics" "$ROOT/tests/adapter/adapter-bytes-percent-format-precision-diagnostics.py" "True ~> .K"
run_case "adapter-bytes-percent-format-width" "$ROOT/tests/adapter/adapter-bytes-percent-format-width.py" "True ~> .K"
run_case "adapter-bytearray-percent-format-width" "$ROOT/tests/adapter/adapter-bytearray-percent-format-width.py" "True ~> .K"
run_case "adapter-bytes-percent-format-width-diagnostics" "$ROOT/tests/adapter/adapter-bytes-percent-format-width-diagnostics.py" "True ~> .K"
...
run_case "adapter-bytes-decode-basic" "$ROOT/tests/adapter/adapter-bytes-decode-basic.py" "True ~> .K"
run_case "adapter-bytearray-decode-basic" "$ROOT/tests/adapter/adapter-bytearray-decode-basic.py" "True ~> .K"
run_case "adapter-bytes-decode-encodings" "$ROOT/tests/adapter/adapter-bytes-decode-encodings.py" "True ~> .K"
run_case "adapter-bytes-decode-diagnostics" "$ROOT/tests/adapter/adapter-bytes-decode-diagnostics.py" "True ~> .K"
run_case "adapter-bytes-decode-error-handlers" "$ROOT/tests/adapter/adapter-bytes-decode-error-handlers.py" "True ~> .K"
run_case "adapter-bytearray-decode-error-handlers" "$ROOT/tests/adapter/adapter-bytearray-decode-error-handlers.py" "True ~> .K"
run_case "adapter-bytes-decode-backslashreplace" "$ROOT/tests/adapter/adapter-bytes-decode-backslashreplace.py" "True ~> .K"
run_case "adapter-bytearray-decode-backslashreplace" "$ROOT/tests/adapter/adapter-bytearray-decode-backslashreplace.py" "True ~> .K"
run_case "adapter-bytes-maketrans-translate" "$ROOT/tests/adapter/adapter-bytes-maketrans-translate.py" "True ~> .K"
run_case "adapter-bytearray-maketrans-translate" "$ROOT/tests/adapter/adapter-bytearray-maketrans-translate.py" "True ~> .K"
run_case "adapter-bytes-translate-diagnostics" "$ROOT/tests/adapter/adapter-bytes-translate-diagnostics.py" "True ~> .K"
...
run_case "adapter-list-sort-keywords" "$ROOT/tests/adapter/adapter-list-sort-keywords.py" "True ~> .K"
...
run_case "adapter-iterator-sorted-builtin" "$ROOT/tests/adapter/adapter-iterator-sorted-builtin.py" "True ~> .K"
run_case "adapter-enumerate-builtin" "$ROOT/tests/adapter/adapter-enumerate-builtin.py" "True ~> .K"
...
run_case "adapter-min-max-unordered-numeric" "$ROOT/tests/adapter/adapter-min-max-unordered-numeric.py" "True ~> .K"
run_case "adapter-iterator-min-max-builtins" "$ROOT/tests/adapter/adapter-iterator-min-max-builtins.py" "True ~> .K"
...
run_case "adapter-dict-fromkeys-update" "$ROOT/tests/adapter/adapter-dict-fromkeys-update.py" "True ~> .K"
run_case "adapter-dict-merge-operators" "$ROOT/tests/adapter/adapter-dict-merge-operators.py" "True ~> .K"
...
run_case "adapter-iterator-three-for-target-comprehensions" "$ROOT/tests/adapter/adapter-iterator-three-for-target-comprehensions.py" "True ~> .K"
run_case "adapter-iterator-three-for-filter-comprehensions" "$ROOT/tests/adapter/adapter-iterator-three-for-filter-comprehensions.py" "True ~> .K"
run_case "adapter-iterator-three-for-target-filter-comprehensions" "$ROOT/tests/adapter/adapter-iterator-three-for-target-filter-comprehensions.py" "True ~> .K"
run_case "adapter-iterator-many-for-comprehensions" "$ROOT/tests/adapter/adapter-iterator-many-for-comprehensions.py" "True ~> .K"
run_case "adapter-generator-expression-basic" "$ROOT/tests/adapter/adapter-generator-expression-basic.py" "True ~> .K"
run_case "adapter-generator-function-basic" "$ROOT/tests/adapter/adapter-generator-function-basic.py" "True ~> .K"
run_case "adapter-async-def-metadata" "$ROOT/tests/adapter/adapter-async-def-metadata.py" "True ~> .K"
...
run_case "adapter-set-mutating-methods" "$ROOT/tests/adapter/adapter-set-mutating-methods.py" "True ~> .K"
