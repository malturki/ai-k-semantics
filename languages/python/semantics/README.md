...
- adapter-backed list displays with supported expression elements, starred unpacking over current ordered concrete iterables, and one-generator list comprehensions over current concrete iterables with simple-name targets and zero or more filter clauses
