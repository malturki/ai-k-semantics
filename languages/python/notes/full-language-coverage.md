...
| Calls and functions | partial | Single-argument lambda values and single-positional calls; needs function definitions, multi-argument call protocol, defaults, varargs, kwargs, closures/cells, decorators, returns, and frames. |
| Containers and comprehensions | partial | Minimal trailing-comma list/tuple value displays, equality, membership, truthiness, and positive indexing; needs full expression-list evaluation, mutation, slices, dicts, sets, ranges, iterators, and comprehensions. |
