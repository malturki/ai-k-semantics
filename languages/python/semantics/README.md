...
- adapter-backed complex values from imaginary literals, with truth-value testing, equality against complex/int/bool/float zero-imaginary values, unary `+`/`-`, and complex addition/subtraction with current int/bool/float/complex values
