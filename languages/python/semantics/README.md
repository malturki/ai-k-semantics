...
- adapter-backed `try/finally` normal-completion and return-propagation subset without `except`, `else`, `break`, or `continue` in the `try`/`finally` bodies
