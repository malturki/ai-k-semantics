...
- adapter-backed function and lambda positional-only parameters, including suffix defaults, varargs-only, and kwargs-only combinations, in the no-keyword-only subset
