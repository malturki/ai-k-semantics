...
- adapter-backed list displays with supported expression elements, starred unpacking over current ordered concrete iterables, and one-, two-, and three-generator list comprehensions over current concrete iterables with simple-name targets or current recursive sequence targets and zero or more filter clauses on each generator
...
- adapter-backed one-, two-, and three-generator dictionary comprehensions over current concrete iterables with simple-name targets or current recursive sequence targets and zero or more filter clauses on each generator, with duplicate key replacement in the supported key-equality subset
...
- adapter-backed one-, two-, and three-generator set comprehensions over current concrete iterables with simple-name targets or current recursive sequence targets and zero or more filter clauses on each generator, with duplicate element normalization
