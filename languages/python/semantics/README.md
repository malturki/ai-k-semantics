...
- adapter-backed function and lambda positional-only parameters, including suffix defaults, varargs-only, kwargs-only, keyword-only, and varargs-plus-kwargs combinations, without simultaneous keyword-only plus varargs/kwargs
